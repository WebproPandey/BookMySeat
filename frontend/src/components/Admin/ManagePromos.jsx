...
export default function ManagePromos() {
  ...
  return (
    <div className="px-6 py-3 bg-gray-200 h-full relative">
      <div className="w-full mx-auto bg-white py-3 px-6 rounded-xl shadow-lg relative">
        ...
        <form
          ...
          className={`transition-all duration-500 overflow-hidden  grid grid-cols-4 gap-2 ${
      ...
      {loading ? (
        ...
        <>
          <div className="my-5 text-xl text-black font-medium">
            All Promo Codes
          </div>

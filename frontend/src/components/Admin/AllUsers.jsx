...
export default function AllUsers() {
  ...
  return (
    <div className=" py-3  px-4 bg-white h-full relative">
      ...
      {loading ? (
        ...
        <div className="space-y-4 grid grid-cols-4  px-2 sticky top-[10vh] z-[8] py-8  gap-x-3 gap-y-3 w-full bg-gray-100  ">
          {users.map((user) => (
